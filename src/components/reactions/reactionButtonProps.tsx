...
const ReactionButton: React.FC<ReactionButtonProps> = ({ onReact }) => {
  ...
  return (
    ...
    >
      <button className="p-2  text-gray-500 hover:text-gray-700 max-w-7">React</button>
      {showReactions && (
        <div className="absolute left-0 max-w-lg flex gap-2 p-2 bg-white shadow-md rounded-lg">
